...
class OpenAudioSynthesizer:
    ...
    def _synthesize_with_api(self, text: str, is_first_segment: bool = False) -> np.ndarray | None:
        ...
        try:
            ...
            if self.self_reference_audio and not is_first_segment and ormsgpack:
                ...
                logger.info("Generating first segment to establish reference voice" if is_first_segment else "No reference available")
            ...
            if response.status_code == 200:
                ...
                try:
                    ...
                    if sample_rate != self.sample_rate:
                        ...
                        waveform = signal.resample(waveform, int(len(waveform) * self.sample_rate / sample_rate))
    ...
    def combine_segments(self, audio_segments: list[AudioSegment], output_sample_rate: int = 16000) -> tuple[np.ndarray, int]:
